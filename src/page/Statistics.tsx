...
export default function Statistics() {
  ...
  if (!stats) return <p>A carregar...</p>;
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-6 mt-6">
        {/* Gráfico linha — observações por mês */}
        ...
        {/* Gráfico donut — distribuição por reino */}
        <section className="bg-white rounded-lg border border-stone-200 p-5">
              ...
              topObservers.map((obs, i) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-stone-500">@{obs.username}</p>
                  </div>
          ...
          <ResponsiveContainer width="100%" height={250}>
            <BarChart data={topSpecies} layout="vertical">
              ...
              <Bar dataKey="total" radius={[0, 4, 4, 0]}>
                {topSpecies.map((s) => (
                  <Cell key={s.species_id} fill={KINGDOM_COLORS[s.kingdom]} />
                ))}
              </Bar>
            </BarChart>
          </ResponsiveContainer>
